...
def load_all_data():
    ...
    for annee in ANNEES:
        ...
        if not os.path.exists(extract_path):
            print(f"⚠️ Dossier dvf_{annee} manquant")
            continue
    ...
    if not foncieres_all.empty:
        ...
        foncieres_all["Valeur fonciere"] = pd.to_numeric(
            foncieres_all["Valeur fonciere"],
            errors="coerce"
        )
    ...
    print("✅ Données générées et mises en cache")
